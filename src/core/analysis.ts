...
import { formatConditionData } from './formatter';
...
// formatConditionData function has been moved to src/core/formatter.ts
/**
 * ヘルスケアデータの統計分析を行う
...
export function analyzeHealthData(data: HealthDataPayload): AnalysisResult {
  ...
  return { metrics, condition_text, system_warnings };
}
